...
def main():
    ...
    try:
        ...
        image_file = os.path.join('images','buba.png')
        GetTextRead(image_file)
...
def GetTextRead(image_file):
    ...
    if result.read is not None:
        ...
        text_to_translate = " ".join(texts_to_translate)
        if text_to_translate:
            try:
                ...
                for idx, item in enumerate(translation):
                    print(f"Translated: {item.translations[0].text}")
